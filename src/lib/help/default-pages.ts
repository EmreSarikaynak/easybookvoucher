...
/** Veritabanı boş veya erişilemezken kullanılan varsayılan içerik */
export const DEFAULT_HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    category: "Destek",
    summary: "Acentelerin talep açması ve admin yanıtı.",
    sections: [
      {
  ...
  },
  {
    ...
    category: "Mobil",
    summary: "Telefona PWA ekleme ve push bildirim izni.",
    sections: [
      {
  ...
  },
  {
    ...
    summary: "Admin taban maliyetleri ve acente satış fiyatları.",
    sections: [
      {
  ...
  },
  {
    ...
    title: "Raporlar",
    category: "Raporlama",
    summary: "Satış ve performans özet ekranı.",
    sections: [
      {
